  ...
  void _generateWiFiQR() {
    if (_ssidController.text.trim().isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Please enter WiFi network name (SSID)'),
    ...
    // Check if password is required for selected security type
    if (_securityType != 'nopass' && _passwordController.text.trim().isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            'Password is required for $_securityType security type',
          ),
          backgroundColor: Colors.red,
        ),
      );
